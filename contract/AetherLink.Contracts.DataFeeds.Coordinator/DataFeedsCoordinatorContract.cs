...
public partial class
    DataFeedsCoordinatorContract : DataFeedsCoordinatorContractContainer.DataFeedsCoordinatorContractBase
{
    public override Empty Initialize(InitializeInput input)
    {
        ...
        {
            RequestTimeoutSeconds = DataFeedsCoordinatorContractConstants.DefaultRequestTimeoutSeconds
        };
