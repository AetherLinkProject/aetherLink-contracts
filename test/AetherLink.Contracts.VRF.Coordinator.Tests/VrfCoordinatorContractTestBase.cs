...
public class VrfCoordinatorContractTestBase : DAppContractTestBase<VrfCoordinatorContractTestModule>
{
    internal Address VrfCoordinatorContractAddress { get; set; }
    internal Address OracleContractAddress { get; set; }
    internal ACS0Container.ACS0Stub ZeroContractStub { get; set; }
    internal VrfCoordinatorContractContainer.VrfCoordinatorContractStub CoordinatorContractStub { get; set; }
    internal VrfCoordinatorContractContainer.VrfCoordinatorContractStub UserCoordinatorContractStub { get; set; }
    ...
    protected VrfCoordinatorContractTestBase()
    {
        ...
        CoordinatorContractStub =
            GetContractStub<VrfCoordinatorContractContainer.VrfCoordinatorContractStub>(VrfCoordinatorContractAddress,
                DefaultKeyPair);
